...
# Function to save my image

def save_as_png():
    
    result = filedialog.asksaveasfilename(initialdir ='d:/udemy projects/Tkinter Project', filetypes = (("png files", "*.png"), ("all files", "*.*")))
    ...
    if result:
        ...
        # Pop up success message message
...
change_colors_frame = LabelFrame(brush_options_frame, text = "Chamge Color")
